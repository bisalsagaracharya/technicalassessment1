...
public class MovieDao {
	...
	public MovieDao() {
		...
		this.url = "jdbc:postgresql://localhost:5432/Movie";
		this.user = "postgres";
		this.password = "Global@123";
		try {
...
//                this.myConn.close();
	...
	public Movie ListOfMovieFromId(String id) {
		...
		return movieListList.stream().filter(movie -> movie.getMovieId().equals(id)).collect(Collectors.toList())
				.get(0);
	}
